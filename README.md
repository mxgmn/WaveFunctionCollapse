...
* [vplesko](https://github.com/vplesko) created a [single-header WFC library in C](https://github.com/vplesko/libwfc), accompanied by a CLI tool and a rudimentary GUI tool.
