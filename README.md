...
* [ofxWFC3D](https://github.com/action-script/ofxWFC3D) is an openFrameworks addon by [Nuño de la Serna](https://action-io.com/). Implements the 3D tile model with extra simetries and features.
